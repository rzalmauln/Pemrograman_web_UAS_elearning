<!-- Edit Modal-->
<div class="modal fade" id="editModal<?php echo $row["id_mahasiswa"] ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body p-3">
                ...
                $id = $row["id_mahasiswa"];
                $edit = mysqli_query($mysqli, "SELECT * FROM mahasiswa INNER JOIN kelas ON mahasiswa.id_kelas = kelas.id_kelas INNER JOIN users ON mahasiswa.id_users = users.id_users WHERE id_mahasiswa='$id'");
                $data = mysqli_fetch_assoc($edit);
                ?>
                <form method="post" action="mahasiswa.php" enctype="multipart/form-data">
                    <div class="d-flex flex-column justify-content-center align-items-center p-4">
                        <div class="mb-3 w-100">
                            <div class="row">
                                <div class="col">
                                    <div class="form-floating mb-3">
                                        ...
                                        <input type="text" name="nrp" class="form-control" id="floatingNRP" required value="<?php echo $data['nrp'] ?>" placeholder="nrp">
                                        <div class="form-text" id="basic-addon4">Masukkan NRP</div>
                                    </div>
                                    <div class="form-floating mb-3">
                                        <label for="floatingNama">Nama</label>
                                        <input type="text" name="nama_mahasiswa" class="form-control" id="floatingNama" required value="<?php echo $data['nama_mahasiswa'] ?>" placeholder="nama">
                                        <div class="form-text" id="basic-addon4">Masukkan nama</div>
                                    </div>
                                    <div class="form-floating mb-3">
                                        <label for="floatingEmail">Email</label>
                                        <input type="email" name="email_mahasiswa" class="form-control" id="floatingEmail" required value="<?php echo $data['email_mahasiswa'] ?>" placeholder="email">
                                ...
                                <div class="col">
                                    <div class="form-floating mb-3">
                                        ...
                                        <input type="text" name="username" class="form-control" id="floatingPassword" value="<?php echo $data['password'] ?>" placeholder="Password">
                            ...
                            <div class="mb-2">
                                ...
                                <div id="preview"></div>
                                <input class="form-control" type="file" name="gambar" value="<?php echo $data['gambar'] ?>" id="formFile" required onchange="previewImage(event)">
