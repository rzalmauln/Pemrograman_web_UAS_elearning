                                    ...
                                    <tbody>
                                        ...
                                        <?php foreach ($data as $row) : ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="" data-toggle="modal" data-target="#editModal<?php echo $row["id_kelas"] ?>" class="btn btn-sm btn-info text-white"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-pencil-square" viewBox="0 0 16 16">
