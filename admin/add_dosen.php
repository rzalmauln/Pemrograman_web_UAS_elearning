...
if (isset($_POST['submit'])) {
    ...
    $result = mysqli_query($mysqli, "INSERT INTO users (username,password,role) VALUE('$username','$password','dosen')");
    ...
    if (in_array($fileType, $allowedTypes)) {
        ...
        if (move_uploaded_file($fileTemp, $uploadPath)) {
            ...
            $sql = "INSERT INTO dosen (id_users,nip,nama_dosen,email_dosen,gambar) 
                    VALUES ('$id_users','$nrp','$nama','$email','$image')";
                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Inputkan Data Dosen</h6>
                        </div>
                        <div class="card-body">
                            <form class="glass col-12 d-flex flex-column justify-content-center align-items-center p-4" method="post" action="add_dosen.php" enctype="multipart/form-data">
                                <?php
                                if (isset($_POST['submit'])) {
                                    if ($result === "Data yang dikirim salah") {
                                        echo '<div class="alert alert-danger" role="alert"> Data yang dikirim salah </div>';
                                    } elseif ($result) {
                                        echo '<div class="alert alert-success" role="alert"> Data berhasil ditambahkan <a class="link-underline-opacity-0" href="dosen.php">View data</a> </div>';
                                    } else {
                                    ...
                                    <div class="row">
                                        <div class="col">
                                            <div class="form-floating mb-3">
                                                ...
                                                <input type="text" name="nip" class="form-control" id="floatingNRP" required placeholder="nip">
                                                <div class="form-text" id="basic-addon4">Masukkan NIP anda</div>
                                            </div>
                                            <div class="form-floating mb-3">
                                                <label for="floatingNama">Nama</label>
                                                <input type="text" name="nama" class="form-control" id="floatingNama" required placeholder="nama">
                                                <div class="form-text" id="basic-addon4">Masukkan nama anda</div>
                                            </div>
                                        </div>
                                        <div class="col">
                                            <div class="form-floating mb-3">
                                                ...
                                                <div class="form-text" id="basic-addon4">Masukkan email anda</div>
                                            </div>
                                            <div class="form-floating mb-3">
