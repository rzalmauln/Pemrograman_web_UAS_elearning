...
if (isset($_POST['edit'])) {
    ...
    if (in_array($fileType, $allowedTypes)) {
        ...
        if (move_uploaded_file($fileTemp, $uploadPath)) {
            ...
            $sql = "UPDATE mahasiswa SET gambar='$gambar' WHERE id_mahasiswa='$id_mahasiswa'";
    ...
    // $edit = mysqli_query($mysqli, "INSERT INTO dosen (gambar) VALUES ('$gambar') WHERE id_mahasiswa='$id_mahasiswa'");
    $edit = mysqli_query($mysqli, "UPDATE mahasiswa SET gambar='$gambar' WHERE id_mahasiswa='$id_mahasiswa'");
    header("Refresh:0");
}
?>
    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                                ...
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center justify-content-center">
                                        <div class="col-5 position-relative">
                                            <img style="object-fit:cover; object-position:center; height:180px; width:180px" src="../img/<?php echo $data_mahasiswa['gambar'] ?>" class="img-thumbnail rounded-circle" alt="">
                                            <a href="" style="right:20px; bottom:0px;" data-toggle="modal" data-target="#editModal<?php echo $data_mahasiswa["id_dosen"] ?>" class="position-absolute btn rounded-circle btn-sm btn-info text-white">
                                    ...
                                    <div class="row no-gutters align-items-center justify-content-center">
                                        <div class="mt-2 " style="width: max-content;">
                                            <h1 class="h3 text-gray-800"><?php echo $data_mahasiswa['nama_mahasiswa'] ?></h1>
                                        </div>
                                    </div>
                                    <div class="row no-gutters align-items-center justify-content-center">
                                        <div class="">
                                    ...
                                    <div class="row no-gutters align-items-center justify-content-center">
                                        <div class="col-6">
                                            <div class="d-flex">
                                                ...
                                                <p class="mx-3"> : </p>
                                                <h1 class="h6 text-gray-600"><?php echo $data_mahasiswa['nrp'] ?></h1>
                                            </div>
                                        </div>
                                        <div class="col-6">
                                            <div class="d-flex">
                                                ...
                                                <p class="mx-3"> : </p>
                                                <h1 class="h6 text-gray-600"><?php echo $data_mahasiswa['email_mahasiswa'] ?></h1>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row no-gutters align-items-center justify-content-center">
                        ...
                        <div class="col-7 mb-4" style="height: 500px;">
                            <div class="card border-left-primary shadow py-2 h-100">
                                <div class="card-body" style="max-height: max-content;">
                                    <h1 class="h3 mb-0 text-gray-800">Daftar Matkul </h1>
                                    <hr class="sidebar-diveder">
                                    <div class="h-75" style="overflow:auto;">
                                        <?php
                                        $sql = "SELECT * FROM mata_kuliah INNER JOIN penilaian ON mata_kuliah.id_matakuliah = penilaian.id_matakuliah WHERE id_mahasiswa = '$data_mahasiswa[id_mahasiswa]'";
                                        $matakuliah_mahasiswa = mysqli_query($mysqli, $sql);
                                        foreach ($matakuliah_mahasiswa as $data) :
                                        ?>
                ...
                <!-- Edit Modal-->
                <div class="modal fade" id="editModal<?php echo $data_mahasiswa["id_dosen"] ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                ...
                                <form method="post" action="index.php" enctype="multipart/form-data">
                                    <div class="d-flex flex-column justify-content-center align-items-end p-4">
                                        <div class="mb-3 w-100">
                                            <div class="mb-2">
                                                <?php echo $data_mahasiswa['gambar'] ?>
                                                <label for="formFile" class="form-label">Pilih foto</label>
                                                <div id="preview"></div>
                                                <input class="form-control" type="file" name="gambar" value="<?php echo $data_mahasiswa['gambar'] ?>" id="formFile" required onchange="previewImage(event)">
                                        ...
                                        <input type="hidden" name="nrp" value="<?php echo $data_mahasiswa['nrp'] ?>">
